...
if low_data:
    ...
    reduction_factor = 1
if label_noise:
    thisFilename = 'cifar_label_noise_' + str(m) + '_' + str(alpha) + '_' + str(batch_size) # This is the general name of all related files
else:
    thisFilename = 'cifar_' + str(m) + '_' + str(alpha) + '_' + str(batch_size) # This is the general name of all related files
...
trainset = dataset.CIFARFiltered(root='./data', labels =[3,5], train=True,
...
print(lr)
val_interval = np.ceil(reduction_factor*100/batch_size*32)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size,
                                          shuffle=True, num_workers=0)
valloader = torch.utils.data.DataLoader(valset, batch_size=batch_size,
                                         shuffle=False, num_workers=0)
testset = dataset.CIFARFiltered(root='./data', labels=[3,5], train=False,
                                       download=True, transform=transform)
